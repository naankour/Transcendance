...
-- CreateIndex
CREATE UNIQUE INDEX "actors_tmdb_id_key" ON "actors"("tmdb_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "favorites_user_id_movie_id_key" ON "favorites"("user_id" ASC, "movie_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "follows_follower_id_followed_id_key" ON "follows"("follower_id" ASC, "followed_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "genres_name_key" ON "genres"("name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "movie_actor_credit_id_key" ON "movie_actor"("credit_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "movie_actor_movie_id_actor_id_character_name_key" ON "movie_actor"("movie_id" ASC, "actor_id" ASC, "character_name" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "movie_genre_movie_id_genre_id_key" ON "movie_genre"("movie_id" ASC, "genre_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "movies_imdb_id_key" ON "movies"("imdb_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "movies_tmdb_id_key" ON "movies"("tmdb_id" ASC);

-- CreateIndex
CREATE UNIQUE INDEX "reviews_user_id_movie_id_key" ON "reviews"("user_id" ASC, "movie_id" ASC);
...
-- CreateIndex
CREATE UNIQUE INDEX "watchlist_user_id_movie_id_key" ON "watchlist"("user_id" ASC, "movie_id" ASC);
